...
class Sepulture implements SluggableInterface, TimestampableInterface, Stringable
{
     ...
     * @var Sihl[]|iterable
     */
    #[ORM\ManyToMany(targetEntity: Sihl::class, inversedBy: 'sepultures', cascade: ['persist'])]
    #[ORM\JoinTable(name: 'sepultures_sihls')]
    private Collection $sihls;
    #[ORM\Column(name: 'statut', type: 'string', length: 255, nullable: true, options: [
        'comment' => 'finis, a relire, erreurs..',
    ])]
    private ?string $statut = null;
    #[ORM\Column(type: 'integer', nullable: true)]
    private ?int $statutSih = null;
    #[ORM\Column(name: 'type_autre', type: 'string', length: 255, nullable: true, options: [
        'comment' => 'autre type',
    ])]
    ...
    #[ORM\Column(name: 'materiaux_autre', type: 'string', length: 255, nullable: true, options: [
        'comment' => 'autre materiaux',
    ])]
    ...
    #[ORM\Column(name: 'aspect_visuel', type: 'string', length: 200, nullable: true, options: [
        'comment' => 'bon,moyen,ruine...',
    ])]
    private ?string $aspect_visuel = null;
    #[ORM\Column(name: 'aspect_legal', type: 'string', length: 200, nullable: true, options: [
        'comment' => 'bon,moyen,ruine...',
    ])]
    private ?string $aspect_legal = null;
    #[ORM\Column(name: 'symbole', type: 'text', nullable: true, options: [
        'comment' => 'epis,fleur,franc-macon...',
    ])]
    private ?string $symbole = null;
    #[ORM\Column(name: 'epitaphe', type: 'text', nullable: true, options: [
        'comment' => 'et devises',
    ])]
    ...
    #[ORM\Column(name: 'architectural', type: 'text', nullable: true, options: [
        'comment' => 'interet historique',
    ])]
    private ?string $architectural = null;
    #[ORM\Column(name: 'sociale', type: 'text', nullable: true, options: [
        'comment' => 'fonction sociale',
    ])]
    private ?string $sociale = null;
    #[ORM\Column(name: 'sociale_check', type: 'boolean', nullable: true, options: [
        'comment' => 'inscription mise ou pas',
    ])]
    private ?bool $sociale_check = null;
    #[ORM\Column(name: 'combattant14', type: 'boolean', nullable: true, options: [
        'comment' => 'ancien combattant 14-18',
    ])]
    private ?bool $combattant14 = null;
    #[ORM\Column(name: 'combattant40', type: 'boolean', nullable: true, options: [
        'comment' => 'ancien combattant 40-45',
    ])]
    private ?bool $combattant40 = null;
    ...
    #[ORM\Column(name: 'guerre', type: 'boolean', nullable: true, options: [
        'comment' => '1er immu avant 45',
    ])]
    private ?bool $guerre = null;
    ...
    #[ORM\Column(name: 'url', type: 'string', nullable: true, options: [
        'comment' => 'genealogie',
    ])]
