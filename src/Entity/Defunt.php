...
class Defunt implements SluggableInterface, TimestampableInterface, Stringable
{
    ...
    private ?int $id = null;
    #[ORM\Column(name: 'nom', type: 'string', length: 150, nullable: false, options: [
        'comment' => 'patronyme',
    ])]
    #[Assert\NotBlank]
    private ?string $nom = null;
    #[ORM\Column(name: 'prenom', type: 'string', length: 150, nullable: true, options: [
        'comment' => 'prenom du mort',
    ])]
    private ?string $prenom = null;
    #[ORM\Column(name: 'fonction', type: 'string', length: 255, nullable: true, options: [
        'comment' => 'fonction social',
    ])]
    private ?string $fonction = null;
    #[ORM\Column(type: 'string', length: 120, nullable: true, options: [
        'comment' => 'date anniversaire',
    ])]
    protected ?string $birthday = null;
    #[ORM\Column(type: 'string', length: 120, nullable: true, options: [
        'comment' => 'date de mort',
    ])]
    protected ?string $date_deces = null;
    #[ORM\Column(name: 'lieu_naissance', type: 'string', length: 255, nullable: true, options: [
        'comment' => 'ne ou',
    ])]
    private ?string $lieu_naissance = null;
    #[ORM\Column(name: 'lieu_deces', type: 'string', length: 255, nullable: true, options: [
        'comment' => 'mort ou',
    ])]
